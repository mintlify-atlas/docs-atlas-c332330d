---
title: "OpenAI Docs Skill: API Reference in Context"
...
| `references/prompting-guide.md` | Fallback for prompt-rewrite work when remote guides fail |
...
| Model ID | Best for |
|---|---|
| `gpt-5.5` | Latest default text and reasoning; most new apps |
| `gpt-5.5-pro` | Maximum reasoning quality when latency matters less |
