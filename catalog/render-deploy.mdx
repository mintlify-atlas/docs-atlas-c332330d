---
title: "Render Deploy Skill: Deploy Services to Render"
sidebarTitle: "Render"
...
<CardGroup cols={2}>
  ...
  <Card title="Static (`runtime: static`)" icon="file">
    SPAs and static sites served via CDN. Set `staticPublishPath` to your build output directory (`./dist`, `./build`, etc.).
  </Card>
