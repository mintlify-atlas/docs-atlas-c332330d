---
title: "WinUI App Skill: Build Windows Desktop Apps in Codex"
sidebarTitle: "WinUI"
...
<Steps>
  <Step title="Environment Audit & Remediation">
    Checking whether a machine can build WinUI apps, or installing missing
    prerequisites — `references/foundation-environment-audit-and-remediation.md`
  </Step>
  ...
  <Step title="Template-First Recovery">
  ...
  <Step title="Build, Run & Launch Verification">
