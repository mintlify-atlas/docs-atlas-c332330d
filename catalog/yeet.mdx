---
title: "Yeet Skill: One-Command PR from Codex"
sidebarTitle: "Yeet"
description: "Stage, commit, push, and open a GitHub pull request in one Codex flow — automatic branch naming, PR template discovery, and structured PR bodies."
---
